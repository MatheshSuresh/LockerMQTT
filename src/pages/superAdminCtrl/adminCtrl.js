...
const AdminCtrl = () => {
    ...
    const getInfo = async () => {
        try {
            const { data } = await axios.get('http://3.239.93.89:4001/locker/lockerdata');
            const users = await axios.get('http://3.239.93.89:4001/user/check');
    ...
    const unlock = async () => {
        await axios.post("http://3.239.93.89:4001/locker/unlock", DashboardInfo[0]);
    }

    const unlockAll = async () => {
        for (let i = 0; i < Dashboarddata.length; i++) {
            await axios.post("http://3.239.93.89:4001/locker/unlock", Dashboarddata[i]);
        }
    }
    ...
    const addlocker = async () => {
        ...
        var addlockerdata = await axios.post(`http://3.239.93.89:4001/locker/insertlocker`, data).then((res) => { return res.data })
    ...
    const editlocker = async () => {
        ...
        var addlockerdata = await axios.post(`http://3.239.93.89:4001/locker/updatealldata`, data).then((res) => { return res.data })
        if (addlockerdata !== null) {
            window.location.reload()
        }
    }
    const Deletelocker=async()=>{
        ...
        console.log(data)
        var addlockerdata = await axios.post(`http://3.239.93.89:4001/locker/deletedata`, data).then((res) => { return res.data })
        if (addlockerdata !== null) {
            window.location.reload()
        }
    }
