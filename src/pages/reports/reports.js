...
const Reports = () => {
    ...
    const getInfo = async () => {
        try {
            ...
            const logdata = await axios.get('http://3.239.93.89:4001/locker/logdata').then((res) => { return res.data })
    ...
    const percentage = async () => {
        ...
        const { data } = await axios.get('http://3.239.93.89:4001/locker/lockerdata');
        const totaldata = await axios.get('http://3.239.93.89:4001/locker/occupied').then((res) => { return res.data })
        var perc = "";
